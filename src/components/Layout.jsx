...
import { Home, Package, Shirt, DollarSign, LogOut, Menu, Download } from "lucide-react";
        ...
        <div className="pt-4 mt-4 border-t border-slate-100 space-y-2">
          ...
          {installPrompt && (
            <Button
              ...
              className="flex w-full items-center gap-3 rounded-2xl px-4 py-3.5 text-sm font-black text-magenta hover:bg-magenta/5 hover:text-magenta hover:shadow-md transition-all border border-magenta/20"
              variant="ghost"
              size="lg"
            >
