  ...
  return (
    <div className="space-y-8">
      <header>
        ...
        <h1 className="text-4xl font-black text-slate-900 tracking-tight uppercase">Contas a Receber</h1>
        <p className="text-slate-500 font-medium italic">Direitos filtrados por status (Pendente/Pago).</p>
      </header>
        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-transparent">
              <TableHead className="text-xs font-black tracking-widest uppercase text-slate-400 w-56">Cliente / Descrição</TableHead>
          ...
          <TableBody>
            {loading ? (
              ...
              <TableRow>
                <TableCell colSpan={4} className="p-20 text-center text-slate-400 italic">Nenhuma conta a receber encontrada.</TableCell>
              </TableRow>
            ) : (
              records.map((record) => (
